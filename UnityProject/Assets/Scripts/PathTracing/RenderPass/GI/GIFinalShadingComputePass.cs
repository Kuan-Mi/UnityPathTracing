...
{
    public class GIFinalShadingComputePass : ScriptableRenderPass
    {
        ...
        public GIFinalShadingComputePass(ComputeShader computeShader)
        {
        ...
        {
            using var builder = renderGraph.AddUnsafePass<PassData>("GIFinalShading_Compute", out var passData);
