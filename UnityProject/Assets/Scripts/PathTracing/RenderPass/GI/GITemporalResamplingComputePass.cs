...
{
    public class GITemporalResamplingComputePass : ScriptableRenderPass
    {
        ...
        public GITemporalResamplingComputePass(ComputeShader computeShader)
        {
        ...
        {
            using var builder = renderGraph.AddUnsafePass<PassData>("GITemporalResampling_Compute", out var passData);
