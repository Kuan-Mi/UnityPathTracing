...
{
    public class GISpatialResamplingComputePass : ScriptableRenderPass
    {
        ...
        public GISpatialResamplingComputePass(ComputeShader computeShader)
        {
        ...
        {
            using var builder = renderGraph.AddUnsafePass<PassData>("GISpatialResampling_Compute", out var passData);
